...
;
(gtk_accel_path "<Actions>/terminal-window/copy-html" "<Primary><Shift><Alt>c")
...
(gtk_accel_path "<Actions>/terminal-window/show-toolbar" "<Primary>t")
...
(gtk_accel_path "<Actions>/terminal-window/show-borders" "<Primary>b")
...
(gtk_accel_path "<Actions>/terminal-window/preferences" "<Primary>p")
...
(gtk_accel_path "<Actions>/terminal-window/last-active-tab" "<Primary>Tab")
; (gtk_accel_path "<Actions>/terminal-window/save-contents" "")
; (gtk_accel_path "<Actions>/terminal-window/goto-tab-2" "<Alt>2")
(gtk_accel_path "<Actions>/terminal-window/close-other-tabs" "<Primary><Shift><Alt>w")
